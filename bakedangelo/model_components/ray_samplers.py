...
class NeuralReconWSampler(Sampler):
    ...
    def __init__(
        ...
        self.grid = nerfacc.OccGridEstimator(aabb.reshape(-1), resolution=self.coarse_resolution)
...
class NeuSAccSampler(Sampler):
    ...
    def __init__(
        ...
        self.grid = nerfacc.OccGridEstimator(aabb.reshape(-1), resolution=self.resolution)
